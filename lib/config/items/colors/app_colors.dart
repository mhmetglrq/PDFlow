...
class AppColors {
  static const Color addImageIconColor = Color(0xffFC1055);
  static const Color addImageBackgroundColor = Color(0xffFFC3D8);
  static const Color pdfConvertIconColor = Color(0xff5798FF);
